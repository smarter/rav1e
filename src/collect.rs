...
extern "C" {
   ...
   out the contributions from AC and DC into separate tables.*/
    #[no_mangle]
    static mut OC_MODE_LOGQ: [[[ogg_int16_t; 2]; 3]; 8];
    #[no_mangle]
...
pub struct oc_fr_state {
    pub bits: ptrdiff_t,
    #[bitfield(name = "sb_partial_count",
               ty = "libc::c_uint",
               bits = "0..=15")]
    #[bitfield(name = "sb_full_count", ty = "libc::c_uint", bits = "16..=31")]
    #[bitfield(name = "b_coded_count_prev",
               ty = "libc::c_uint",
               bits = "32..=37")]
    ...
    #[bitfield(name = "sb_prefer_partial",
               ty = "libc::c_uint",
               bits = "53..=53")]
    ...
    pub sb_partial_count_sb_full_count_b_coded_count_prev_b_coded_prev_b_coded_count_b_coded_b_count_sb_prefer_partial_sb_partial_sb_bits_sb_full: [u8; 8],
}
...
pub type oc_token_skip_func
    =
    Option<unsafe extern "C" fn(_: libc::c_int, _: libc::c_int) -> ptrdiff_t>;
/* *******************************************************************
 *                                                                  *
 * THIS FILE IS PART OF THE OggTheora SOFTWARE CODEC SOURCE CODE.   *
 * USE, DISTRIBUTION AND REPRODUCTION OF THIS LIBRARY SOURCE IS     *
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_add(mut _metrics:
                                                 *mut oc_mode_metrics,
                                             mut _w: libc::c_double,
                                             mut _s: libc::c_int,
                                             mut _q: libc::c_int,
                                             mut _r: libc::c_int,
    ...
    if (*_metrics).w > 0i32 as libc::c_double {
        ...
        (*_metrics).s2q2 +=
            -2i32 as libc::c_double * (ds * sq2 + dq * s2q) * rwb +
                (ds2 * q2 + 4i32 as libc::c_double * ds * dq * sq + dq2 * s2)
                    * rwb2 + ds2 * dq2 * rw4;
        (*_metrics).s2q +=
            (-2i32 as libc::c_double * ds * sq - dq * s2) * rwb +
                ds2 * dq * rw3;
        (*_metrics).sq2 +=
            (-ds * q2 - 2i32 as libc::c_double * dq * sq) * rwb +
                ds * dq2 * rw3;
        (*_metrics).sqr +=
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_merge(mut _dst: *mut oc_mode_metrics,
                                               mut _src:
                                                   *const oc_mode_metrics,
                                               mut _n: libc::c_int) {
    ...
    if i >= _n {
        memset(_dst as *mut libc::c_void, 0i32,
               ::std::mem::size_of::<oc_mode_metrics>() as libc::c_ulong);
        return
    }
    memcpy(_dst as *mut libc::c_void,
    ...
    while i < _n {
        if (*_src.offset(i as isize)).w != 0i32 as libc::c_double {
            ...
            (*_dst).s2q2 +=
                (*_src.offset(i as isize)).s2q2 +
                    2i32 as libc::c_double *
                        (ds * (rwa * sq2b - rwb * sq2a) +
                             dq * (rwa * s2qb - rwb * s2qa)) +
                    ds2 * (rwa2 * q2b + rwb2 * q2a) +
                    4i32 as libc::c_double * ds * dq *
                        (rwa2 * sqb + rwb2 * sqa) +
                    dq2 * (rwa2 * s2b + rwb2 * s2a) + ds2 * dq2 * rw4;
            (*_dst).s2q +=
                (*_src.offset(i as isize)).s2q +
                    2i32 as libc::c_double * ds * (rwa * sqb - rwb * sqa) +
                    dq * (rwa * s2b - rwb * s2a) + ds2 * dq * rw3;
            (*_dst).sq2 +=
                (*_src.offset(i as isize)).sq2 + ds * (rwa * q2b - rwb * q2a)
                    + 2i32 as libc::c_double * dq * (rwa * sqb - rwb * sqa) +
                    ds * dq2 * rw3;
            (*_dst).sqr +=
                (*_src.offset(i as isize)).sqr + ds * (rwa * qrb - rwb * qra)
                    + dq * (rwa * srb - rwb * sra) +
                    dr * (rwa * sqb - rwb * sqa) + ds * dq * dr * rw3;
            (*_dst).sqd +=
                (*_src.offset(i as isize)).sqd + ds * (rwa * qdb - rwb * qda)
                    + dq * (rwa * sdb - rwb * sda) +
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_solve(mut _r: *mut libc::c_double,
                                               mut _d: *mut libc::c_double,
                                               mut _metrics:
                                                   *const oc_mode_metrics,
                                               mut _s0: *const libc::c_int,
                                               mut _s1: *const libc::c_int,
                                               mut _q0: *const libc::c_int,
                                               mut _q1: *const libc::c_int,
                                               mut _ra: *const libc::c_double,
                                               mut _rb: *const libc::c_double,
                                               mut _rc: *const libc::c_double,
                                               mut _da: *const libc::c_double,
                                               mut _db: *const libc::c_double,
                                               mut _dc: *const libc::c_double,
                                               mut _n: libc::c_int)
 -> libc::c_double {
    ...
    while i < _n {
        if (*_metrics.offset(i as isize)).w > 0i32 as libc::c_double {
            ...
            wt += w;
            s10 =
                (*_s1.offset(i as isize) - *_s0.offset(i as isize)) as
                    libc::c_double;
            q10 =
                (*_q1.offset(i as isize) - *_q0.offset(i as isize)) as
                    libc::c_double;
            sq10 = s10 * q10;
            ds =
            ...
            dq =
                (*_metrics.offset(i as isize)).q / w -
            ...
            xx +=
                (dq2 * (ds2 * w + s2) + 4i32 as libc::c_double * ds * dq * sq
                     + ds2 * q2 +
                     2i32 as libc::c_double * (dq * s2q + ds * sq2) + s2q2) /
                    (sq10 * sq10);
            ...
            c3 =
                -(*_ra.offset(i as isize) - *_rb.offset(i as isize) -
                      *_rc.offset(i as isize)) / sq10;
            rxy +=
                (ds * dq * (r + c0 + c1 * ds + c2 * dq + c3 * ds * dq) * w +
                     (c1 * dq + c3 * dq2) * s2 +
                     (r + c0 +
                          2i32 as libc::c_double *
                              (c1 * ds +
                                   (c2 + 2i32 as libc::c_double * c3 * ds) *
                                       dq)) * sq + (c2 * ds + c3 * ds2) * q2 +
                     dq * sr + ds * qr +
                     (c1 + 2i32 as libc::c_double * c3 * dq) * s2q +
                     (c2 + 2i32 as libc::c_double * c3 * ds) * sq2 + sqr +
                     c3 * s2q2) / sq10;
            ...
            c3 =
                -(*_da.offset(i as isize) - *_db.offset(i as isize) -
                      *_dc.offset(i as isize)) / sq10;
            dxy +=
                (ds * dq * (d + c0 + c1 * ds + c2 * dq + c3 * ds * dq) * w +
                     (c1 * dq + c3 * dq2) * s2 +
                     (d + c0 +
                          2i32 as libc::c_double *
                              (c1 * ds +
                     ...
                     dq * sd + ds * qd +
                     (c1 + 2i32 as libc::c_double * c3 * dq) * s2q +
                     (c2 + 2i32 as libc::c_double * c3 * ds) * sq2 + sqd +
                     c3 * s2q2) / sq10
        }
        i += 1
    }
    if xx > 1E-3f64 {
        *_r = rxy / xx;
        *_d = dxy / xx
    } else { *_r = 0i32 as libc::c_double; *_d = 0i32 as libc::c_double }
    return wt;
}
/*Compile collected SATD/logq/rate/RMSE metrics into a form that's immediately
   useful for mode decision.*/
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_update(mut _metrics:
                                                    *mut [[[oc_mode_metrics; 24]; 2]; 3],
                                                mut _niters_min: libc::c_int,
                                                mut _reweight: libc::c_int,
                                                mut _table:
                                                    *mut [[[oc_mode_rd; 24]; 2]; 3],
                                                mut _shift: libc::c_int,
                                                mut _weight:
                                                    *mut [[[libc::c_double; 24]; 2]; 3]) {
                ...
                while qi < 8i32 {
                    ...
                    while si < 24i32 {
                        ...
                        if qi > 0i32 && si > 0i32 {
                            ...
                            ra[n as usize] =
                                ldexp((*_table.offset((qi - 1i32) as
                                                          isize))[pli as
                                                                      usize][qti
                                                                                 as
                                                                                 usize][(si
                            ...
                            let fresh0 = n;
                            n = n + 1;
                            *m.as_mut_ptr().offset(fresh0 as isize) =
                                *(*_metrics.offset((qi - 1i32) as
                                                       isize))[pli as
                                                                   usize][qti
                                                                              as
                                                                              usize].as_mut_ptr().offset(si
                                                                                                             as
                                                                                                             isize).offset(-1isize)
                        }
                        if qi > 0i32 {
                            ...
                            let fresh1 = n;
                            n = n + 1;
                            *m.as_mut_ptr().offset(fresh1 as isize) =
                                *(*_metrics.offset((qi - 1i32) as
                                                       isize))[pli as
                                                                   usize][qti
                                                                              as
                        ...
                        if qi + 1i32 < 8i32 && si > 0i32 {
                            ...
                            let fresh2 = n;
                            n = n + 1;
                            *m.as_mut_ptr().offset(fresh2 as isize) =
                                *(*_metrics.offset(qi as
                                                       isize))[pli as
                                                                   usize][qti
                                                                              as
                                                                              usize].as_mut_ptr().offset(si
                        ...
                        if qi + 1i32 < 8i32 {
                            ...
                            let fresh3 = n;
                            n = n + 1;
                            *m.as_mut_ptr().offset(fresh3 as isize) =
                                *(*_metrics.offset(qi as
                                                       isize))[pli as
                                                                   usize][qti
                                                                              as
                        ...
                        if 0 == OC_HAS_MODE_METRICS && niters == 0i32 {
                            ...
                            r =
                                if w > 1E-3f64 {
                                    r / w
                                } else { 0i32 as libc::c_double };
                            d =
                                if w > 1E-3f64 {
                                    d / w
                                } else { 0i32 as libc::c_double };
                            (*_weight.offset(qi as
                                                 isize))[pli as
                                                             usize][qti as
                                                                        usize][si
                                                                                   as
                                                 ...
                                                 isize))[pli as
                                                             usize][qti as
                                                                        usize][si
                                                                                   ...
                                                                                   usize]
                                =
                                oc_mode_metrics_solve(&mut r, &mut d,
                                                      m.as_mut_ptr(),
                                                      s0.as_mut_ptr(),
                                                      s1.as_mut_ptr(),
                                                      q0.as_mut_ptr(),
                                                 ...
                                                 isize))[pli as
                                                             usize][qti as
                                                                        usize][si
                                                                                   as
                                                                                   usize].rate
                                 as libc::c_int as libc::c_double * wt +
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_dump() {
    let mut fmetrics: *mut FILE = 0 as *mut FILE;
    fmetrics =
        fopen(OC_MODE_METRICS_FILENAME,
              b"wb\x00" as *const u8 as *const libc::c_char);
    if !fmetrics.is_null() {
        fwrite(OC_MODE_LOGQ.as_mut_ptr() as *const libc::c_void,
               ::std::mem::size_of::<[[[ogg_int16_t; 2]; 3]; 8]>() as
                   libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
        fwrite(OC_MODE_METRICS_SATD.as_mut_ptr() as *const libc::c_void,
               ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                   as libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
        fwrite(OC_MODE_METRICS_SAD.as_mut_ptr() as *const libc::c_void,
               ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                   as libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
        fclose(fmetrics);
    };
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_print_rd(mut _fout: *mut FILE,
                                                  mut _table_name:
                                                      *const libc::c_char,
                                                  mut _mode_rd_table:
                                                      *mut [[[oc_mode_rd; 24]; 2]; 3]) {
    let mut qii: libc::c_int = 0;
    fprintf(_fout,
            b"# if !defined(OC_COLLECT_METRICS)\nstatic const\n# endif\noc_mode_rd %s[OC_LOGQ_BINS][3][2][OC_COMP_BINS]={\n\x00"
                as *const u8 as *const libc::c_char, _table_name);
    qii = 0i32;
    while qii < 8i32 {
        let mut pli: libc::c_int = 0;
        ...
        while pli < 3i32 {
            ...
            while qti < 2i32 {
                ...
                let mut qi: libc::c_int = 0;
                static mut pl_names: [*const libc::c_char; 3] =
                    [b"Y\'\x00" as *const u8 as *const libc::c_char,
                     b"Cb\x00" as *const u8 as *const libc::c_char,
                     b"Cr\x00" as *const u8 as *const libc::c_char];
                static mut qti_names: [*const libc::c_char; 2] =
                    [b"INTRA\x00" as *const u8 as *const libc::c_char,
                     b"INTER\x00" as *const u8 as *const libc::c_char];
                qi = (63i32 * qii + (8i32 - 1i32 >> 1i32)) / (8i32 - 1i32);
                fprintf(_fout,
                        b"      /*%s  qi=%i  %s*/\n\x00" as *const u8 as
                            *const libc::c_char, pl_names[pli as usize], qi,
                        qti_names[qti as usize]);
                fprintf(_fout,
                        b"      {\n\x00" as *const u8 as *const libc::c_char);
                fprintf(_fout,
                ...
                bin = 0i32;
                while bin < 24i32 {
                    if 0 != bin && 0 == bin & 0x3i32 {
                        fprintf(_fout,
                                b"\n        \x00" as *const u8 as
                                    *const libc::c_char);
                    }
                    fprintf(_fout,
                            b"{%5i,%5i}\x00" as *const u8 as
                                *const libc::c_char,
                            (*_mode_rd_table.offset(qii as
                                                        isize))[pli as
                                                                    usize][qti
                                                                               as
                                                                               usize][bin
            ...
            fprintf(_fout, b"    }\x00" as *const u8 as *const libc::c_char);
            if pli < 2i32 {
                fprintf(_fout, b",\x00" as *const u8 as *const libc::c_char);
            }
            fprintf(_fout, b"\n\x00" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn oc_mode_metrics_print(mut _fout: *mut FILE) {
    let mut qii: libc::c_int = 0;
    fprintf(_fout,
            b"/*File generated by libtheora with OC_COLLECT_METRICS defined at compile time.*/\n#if !defined(_modedec_H)\n# define _modedec_H (1)\n# include \"encint.h\"\n\n\n\n/*The log of the average quantizer for each of the OC_MODE_RD table rows\n   (e.g., for the represented qi\'s, and each pli and qti), in Q10 format.\n  The actual statistics used by the encoder will be interpolated from\n   that table based on log_plq for the actual quantization matrix used.*/\n# if !defined(OC_COLLECT_METRICS)\nstatic const\n# endif\nogg_int16_t OC_MODE_LOGQ[OC_LOGQ_BINS][3][2]={\n\x00"
                as *const u8 as *const libc::c_char);
    qii = 0i32;
    while qii < 8i32 {
        fprintf(_fout,
                b"  { {0x%04X,0x%04X},{0x%04X,0x%04X},{0x%04X,0x%04X} }%s\n\x00"
                    as *const u8 as *const libc::c_char,
                OC_MODE_LOGQ[qii as usize][0usize][0usize] as libc::c_int,
                OC_MODE_LOGQ[qii as usize][0usize][1usize] as libc::c_int,
                OC_MODE_LOGQ[qii as usize][1usize][0usize] as libc::c_int,
                OC_MODE_LOGQ[qii as usize][1usize][1usize] as libc::c_int,
                OC_MODE_LOGQ[qii as usize][2usize][0usize] as libc::c_int,
                OC_MODE_LOGQ[qii as usize][2usize][1usize] as libc::c_int,
                if qii + 1i32 < 8i32 {
                    b",\x00" as *const u8 as *const libc::c_char
    ...
    fprintf(_fout, b"};\n\n\x00" as *const u8 as *const libc::c_char);
    oc_mode_metrics_print_rd(_fout,
                             b"OC_MODE_RD_SATD\x00" as *const u8 as
                                 *const libc::c_char,
                             OC_MODE_RD_SATD.as_mut_ptr());
    oc_mode_metrics_print_rd(_fout,
                             b"OC_MODE_RD_SAD\x00" as *const u8 as
                                 *const libc::c_char,
                             OC_MODE_RD_SAD.as_mut_ptr());
    fprintf(_fout, b"#endif\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn oc_enc_mode_metrics_load(mut _enc: *mut oc_enc_ctx) {
    if 0 == OC_HAS_MODE_METRICS {
        let mut fmetrics: *mut FILE = 0 as *mut FILE;
        memset(OC_MODE_METRICS_SATD.as_mut_ptr() as *mut libc::c_void, 0i32,
               ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                   as libc::c_ulong);
        memset(OC_MODE_METRICS_SAD.as_mut_ptr() as *mut libc::c_void, 0i32,
               ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                   as libc::c_ulong);
        fmetrics =
            fopen(OC_MODE_METRICS_FILENAME,
        ...
        if !fmetrics.is_null() {
            fread(OC_MODE_LOGQ.as_mut_ptr() as *mut libc::c_void,
                  ::std::mem::size_of::<[[[ogg_int16_t; 2]; 3]; 8]>() as
                      libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
            fread(OC_MODE_METRICS_SATD.as_mut_ptr() as *mut libc::c_void,
                  ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                      as libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
            fread(OC_MODE_METRICS_SAD.as_mut_ptr() as *mut libc::c_void,
                  ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
                      as libc::c_ulong, 1i32 as libc::c_ulong, fmetrics);
            fclose(fmetrics);
        } else {
            ...
            while qii < 8i32 {
                ...
                while pli < 3i32 {
                    qti = 0i32;
                    while qti < 2i32 {
                        OC_MODE_LOGQ[qii as usize][pli as usize][qti as usize]
                            =
                            (*_enc).log_plq[qi as
                                                usize][pli as
                                                           usize][qti as
        ...
        oc_mode_metrics_update(OC_MODE_METRICS_SATD.as_mut_ptr(), 100i32,
                               1i32, OC_MODE_RD_SATD.as_mut_ptr(), 9i32,
                               OC_MODE_RD_WEIGHT_SATD.as_mut_ptr());
        oc_mode_metrics_update(OC_MODE_METRICS_SAD.as_mut_ptr(), 100i32, 1i32,
                               OC_MODE_RD_SAD.as_mut_ptr(), 6i32,
                               OC_MODE_RD_WEIGHT_SAD.as_mut_ptr());
        OC_HAS_MODE_METRICS = 1i32
    };
}
/*Handles the simple end of block tokens.*/
unsafe extern "C" fn oc_token_skip_eob(mut _token: libc::c_int,
                                       mut _extra_bits: libc::c_int)
 -> ptrdiff_t {
    let mut nblocks_adjust: libc::c_int = 0;
    nblocks_adjust =
        ((0i32 & 0xfi32 | (1i32 & 0xfi32) << 4i32 | (2i32 & 0xfi32) << 8i32 |
              (3i32 & 0xfi32) << 12i32 | (7i32 & 0xfi32) << 16i32 |
              (15i32 & 0xfi32) << 20i32 | (0i32 & 0xfi32) << 24i32 |
              (0i32 & 0xfi32) << 28i32) >> _token * 4i32 & 0xfi32) + 1i32;
    return (-_extra_bits - nblocks_adjust) as ptrdiff_t;
}
/*The last EOB token has a special case, where an EOB run of size zero ends all
   the remaining blocks in the frame.*/
unsafe extern "C" fn oc_token_skip_eob6(mut _token: libc::c_int,
                                        mut _extra_bits: libc::c_int)
 -> ptrdiff_t {
    if 0 == _extra_bits {
        return (!(0i32 as size_t) >> 1i32).wrapping_neg() as ptrdiff_t
    }
    return -_extra_bits as ptrdiff_t;
}
/*Handles the pure zero run tokens.*/
unsafe extern "C" fn oc_token_skip_zrl(mut _token: libc::c_int,
                                       mut _extra_bits: libc::c_int)
 -> ptrdiff_t {
    return (_extra_bits + 1i32) as ptrdiff_t;
}
/*Handles a normal coefficient value token.*/
unsafe extern "C" fn oc_token_skip_val() -> ptrdiff_t {
    return 1i32 as ptrdiff_t;
}
/*Handles a category 1A zero run/coefficient value combo token.*/
unsafe extern "C" fn oc_token_skip_run_cat1a(mut _token: libc::c_int)
 -> ptrdiff_t {
    return (_token - 23i32 + 2i32) as ptrdiff_t;
}
/*Handles category 1b, 1c, 2a, and 2b zero run/coefficient value combo tokens.*/
unsafe extern "C" fn oc_token_skip_run(mut _token: libc::c_int,
                                       mut _extra_bits: libc::c_int)
 -> ptrdiff_t {
    let mut run_cati: libc::c_int = 0;
    let mut ncoeffs_mask: libc::c_int = 0;
    let mut ncoeffs_adjust: libc::c_int = 0;
    run_cati = _token - 28i32;
    ncoeffs_mask =
        ((3i32 & 0xffi32 | (7i32 & 0xffi32) << 8i32 |
              (0i32 & 0xffi32) << 16i32 | (1i32 & 0xffi32) << 24i32) >>
             run_cati * 8i32) as libc::c_schar as libc::c_int;
    ncoeffs_adjust =
        ((7i32 & 0xffi32 | (11i32 & 0xffi32) << 8i32 |
              (2i32 & 0xffi32) << 16i32 | (3i32 & 0xffi32) << 24i32) >>
             run_cati * 8i32) as libc::c_schar as libc::c_int;
    return ((_extra_bits & ncoeffs_mask) + ncoeffs_adjust) as ptrdiff_t;
}
...
static mut OC_TOKEN_SKIP_TABLE: [oc_token_skip_func; 32] =
    unsafe {
        [Some(oc_token_skip_eob as
         ...
         Some(oc_token_skip_eob as
                  unsafe extern "C" fn(_: libc::c_int, _: libc::c_int)
                      -> ptrdiff_t),
         Some(oc_token_skip_eob6 as
                  unsafe extern "C" fn(_: libc::c_int, _: libc::c_int)
                      -> ptrdiff_t),
         Some(oc_token_skip_zrl as
                  unsafe extern "C" fn(_: libc::c_int, _: libc::c_int)
                      -> ptrdiff_t),
         Some(oc_token_skip_zrl as
                  unsafe extern "C" fn(_: libc::c_int, _: libc::c_int)
                      -> ptrdiff_t),
         ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ptrdiff_t>,
                                 oc_token_skip_func>(Some(oc_token_skip_val as
                                                              unsafe extern "C" fn()
                                                                  ->
                                                                      ptrdiff_t)),
         ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ptrdiff_t>,
         ...
         ::std::mem::transmute::<Option<unsafe extern "C" fn(_: libc::c_int)
                                            -> ptrdiff_t>,
                                 oc_token_skip_func>(Some(oc_token_skip_run_cat1a
                                                              as
...
unsafe extern "C" fn oc_dct_token_skip(mut _token: libc::c_int,
                                       mut _extra_bits: libc::c_int)
 -> ptrdiff_t {
    return OC_TOKEN_SKIP_TABLE[_token as
                                   usize].expect("non-null function pointer")(_token,
                                                                              _extra_bits);
}
#[no_mangle]
pub unsafe extern "C" fn oc_enc_mode_metrics_collect(mut _enc:
                                                         *mut oc_enc_ctx) {
    static mut OC_ZZI_HUFF_OFFSET: [libc::c_uchar; 64] =
        [0i32 as libc::c_uchar, 16i32 as libc::c_uchar,
         16i32 as libc::c_uchar, 16i32 as libc::c_uchar,
         16i32 as libc::c_uchar, 16i32 as libc::c_uchar,
         32i32 as libc::c_uchar, 32i32 as libc::c_uchar,
         32i32 as libc::c_uchar, 32i32 as libc::c_uchar,
         32i32 as libc::c_uchar, 32i32 as libc::c_uchar,
         32i32 as libc::c_uchar, 32i32 as libc::c_uchar,
         32i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         48i32 as libc::c_uchar, 48i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         ...
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar,
         64i32 as libc::c_uchar, 64i32 as libc::c_uchar, 0, 0, 0, 0, 0, 0, 0,
         0];
    let mut frags: *const oc_fragment = 0 as *const oc_fragment;
    let mut frag_sad: *const libc::c_uint = 0 as *const libc::c_uint;
    let mut frag_satd: *const libc::c_uint = 0 as *const libc::c_uint;
    let mut frag_ssd: *const libc::c_uint = 0 as *const libc::c_uint;
    let mut coded_fragis: *const ptrdiff_t = 0 as *const ptrdiff_t;
    let mut ncoded_fragis: ptrdiff_t = 0;
    let mut fragii: ptrdiff_t = 0;
    let mut fragw: libc::c_double = 0.;
    let mut modelines: [[[libc::c_int; 2]; 3]; 3] = [[[0; 2]; 3]; 3];
    let mut qti: libc::c_int = 0;
    let mut qii: libc::c_int = 0;
    let mut qi: libc::c_int = 0;
    let mut pli: libc::c_int = 0;
    let mut zzi: libc::c_int = 0;
    let mut token: libc::c_int = 0;
    let mut eb: libc::c_int = 0;
    qii = 0i32;
    while qii < (*_enc).state.nqis as libc::c_int {
        pli = 0i32;
        while pli < 3i32 {
            qti = 0i32;
            while qti < 2i32 {
                let mut log_plq: libc::c_int = 0;
                let mut modeline: libc::c_int = 0;
                log_plq =
                    (*_enc).log_plq[(*_enc).state.qis[qii as usize] as
                                        usize][pli as usize][qti as usize] as
                        libc::c_int;
                modeline = 0i32;
                while modeline < 8i32 - 1i32 &&
                          OC_MODE_LOGQ[(modeline + 1i32) as
                                           usize][pli as usize][qti as usize]
                              as libc::c_int > log_plq {
                    modeline += 1
                }
                modelines[qii as usize][pli as usize][qti as usize] =
                    modeline;
                qti += 1
            }
            pli += 1
    ...
    qti = (*_enc).state.frame_type as libc::c_int;
    frags = (*_enc).state.frags;
    frag_sad = (*_enc).frag_sad;
    frag_satd = (*_enc).frag_satd;
    frag_ssd = (*_enc).frag_ssd;
    coded_fragis = (*_enc).state.coded_fragis;
    fragii = 0i32 as ptrdiff_t;
    ncoded_fragis = fragii;
    fragw = 1.0f64 / (*_enc).state.nfrags as libc::c_double;
    pli = 0i32;
    while pli < 3i32 {
        let mut ti: [ptrdiff_t; 64] = [0; 64];
        let mut eob_token: [libc::c_int; 64] = [0; 64];
        let mut eob_run: [libc::c_int; 64] = [0; 64];
        zzi = 0i32;
        while zzi < 64i32 {
            ti[zzi as usize] =
                (*_enc).dct_token_offs[pli as usize][zzi as usize] as
                    ptrdiff_t;
            if ti[zzi as usize] > 0i32 as libc::c_long {
                token =
                    *(*(*_enc).dct_tokens[pli as
                                              usize].offset(zzi as
                                                                isize)).offset(0isize)
                        as libc::c_int;
                eb =
                    *(*(*_enc).extra_bits[pli as
                                              usize].offset(zzi as
                                                                isize)).offset(0isize)
                        as libc::c_int;
                eob_token[zzi as usize] = token;
                eob_run[zzi as usize] =
                    -oc_dct_token_skip(token, eb) as libc::c_int
            } else {
                eob_token[zzi as usize] = 7i32;
                eob_run[zzi as usize] = 0i32
            }
            zzi += 1
        }
        ncoded_fragis += (*_enc).state.ncoded_fragis[pli as usize];
        while fragii < ncoded_fragis {
            let mut fragi: ptrdiff_t = 0;
            let mut frag_bits: libc::c_int = 0;
            let mut huffi: libc::c_int = 0;
            let mut skip: libc::c_int = 0;
            let mut mb_mode: libc::c_int = 0;
            let mut sad: libc::c_uint = 0;
            let mut satd: libc::c_uint = 0;
            let mut sqrt_ssd: libc::c_double = 0.;
            let mut bin: libc::c_int = 0;
            let mut qtj: libc::c_int = 0;
            fragi = *coded_fragis.offset(fragii as isize);
            frag_bits = 0i32;
            zzi = 0i32;
            while zzi < 64i32 {
                if eob_run[zzi as usize] > 0i32 {
                    eob_run[zzi as usize] -= 1;
                    break ;
                } else {
                    huffi =
                        (*_enc).huff_idxs[qti as
                                              usize][(zzi > 0i32) as
                                                         libc::c_int as
                                                         usize][(pli + 1i32 >>
                                                                     1i32) as
                                                                    usize] as
                            libc::c_int +
                            OC_ZZI_HUFF_OFFSET[zzi as usize] as libc::c_int;
                    if eob_token[zzi as usize] < 7i32 {
                        frag_bits +=
                            (*_enc).huff_codes[huffi as
                                                   usize][eob_token[zzi as
                                                                        usize]
                                                              as usize].nbits
                                +
                                OC_DCT_TOKEN_EXTRA_BITS[eob_token[zzi as
                                                                      usize]
                                                            as usize] as
                                    libc::c_int;
                        eob_token[zzi as usize] = 7i32
                    ...
                    eb =
                        *(*(*_enc).extra_bits[pli as
                            ...
                            as libc::c_int;
                    ti[zzi as usize] += 1;
                    skip = oc_dct_token_skip(token, eb) as libc::c_int;
                    if skip < 0i32 {
                        eob_token[zzi as usize] = token;
                        eob_run[zzi as usize] = -skip
                    } else {
                        frag_bits +=
                            (*_enc).huff_codes[huffi as
                                                   usize][token as
                                                              usize].nbits +
                                OC_DCT_TOKEN_EXTRA_BITS[token as usize] as
                                    libc::c_int;
                        zzi += skip
                    }
                }
            ...
            mb_mode =
                (*frags.offset(fragi as isize)).mb_mode() as libc::c_int;
            qii = (*frags.offset(fragi as isize)).qii() as libc::c_int;
            qi = (*_enc).state.qis[qii as usize] as libc::c_int;
            sad = *frag_sad.offset(fragi as isize) << (pli + 1i32 & 2i32);
            satd = *frag_satd.offset(fragi as isize) << (pli + 1i32 & 2i32);
            sqrt_ssd =
                sqrt(*frag_ssd.offset(fragi as isize) as libc::c_double);
            qtj = (mb_mode != 1i32) as libc::c_int;
            bin =
                (satd >>
                     9i32).wrapping_add(((24i32 - 1i32) as
                                             libc::c_uint).wrapping_sub(satd
                                                                            >>
                                                                            9i32)
                                            &
                                            -((((24i32 - 1i32) as
            ...
            oc_mode_metrics_add(OC_MODE_METRICS_SATD[modelines[qii as
                                                                   usize][pli
                                                                              as
                                                                              usize][qtj
                                                                                         as
                                                         ...
                                                         usize][pli as
                                                                    usize][qtj
                                                                               as
                                                                               usize].as_mut_ptr().offset(bin
                                                                                                              as
                                                                                                              isize),
                                fragw, satd as libc::c_int,
                                (*_enc).log_plq[qi as
                                                    usize][pli as
                                                               usize][qtj as
                                                                          usize]
                                    as libc::c_int, frag_bits, sqrt_ssd);
            bin =
                (sad >>
                     6i32).wrapping_add(((24i32 - 1i32) as
                                             libc::c_uint).wrapping_sub(sad >>
                                                                            6i32)
                                            &
                                            -((((24i32 - 1i32) as
                                                    libc::c_uint) <
                                                  ...
                                                  libc::c_int) as
                                                libc::c_uint) as libc::c_int;
            oc_mode_metrics_add(OC_MODE_METRICS_SAD[modelines[qii as
                                                                  usize][pli
                                                                             as
                                                                             usize][qtj
                                                                                        as
    ...
    oc_mode_metrics_update(OC_MODE_METRICS_SATD.as_mut_ptr(), 4i32, 1i32,
                           OC_MODE_RD_SATD.as_mut_ptr(), 9i32,
                           OC_MODE_RD_WEIGHT_SATD.as_mut_ptr());
    oc_mode_metrics_update(OC_MODE_METRICS_SAD.as_mut_ptr(), 4i32, 1i32,
                           OC_MODE_RD_SAD.as_mut_ptr(), 6i32,
                           OC_MODE_RD_WEIGHT_SAD.as_mut_ptr());
}
