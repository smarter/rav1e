      ...
      while qti < 2i32 {
        ...
        while qi < 8i32 {
          ...
          while si < 24i32 {
            ...
            n = 0i32;
            if qi > 0i32 && si > 0i32 {
              q0[n as usize] = OC_MODE_LOGQ[(qi - 1i32) as usize][pli as usize]
                [qti as usize] as libc::c_int;
              q1[n as usize] = OC_MODE_LOGQ[qi as usize][pli as usize]
                [qti as usize] as libc::c_int;
...
#[no_mangle]
pub unsafe extern fn oc_mode_metrics_dump() {
  let mut fmetrics: *mut FILE = 0 as *mut FILE;
  fmetrics = fopen(
    OC_MODE_METRICS_FILENAME,
    b"wb\x00" as *const u8 as *const libc::c_char
  );
  if !fmetrics.is_null() {
    fwrite(
      OC_MODE_LOGQ.as_mut_ptr() as *const libc::c_void,
      ::std::mem::size_of::<[[[ogg_int16_t; 2]; 3]; 8]>() as libc::c_ulong,
      1i32 as libc::c_ulong,
      fmetrics
    );
    fwrite(
      OC_MODE_METRICS_SATD.as_mut_ptr() as *const libc::c_void,
    ...
    fwrite(
      OC_MODE_METRICS_SAD.as_mut_ptr() as *const libc::c_void,
      ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
        as libc::c_ulong,
      1i32 as libc::c_ulong,
      fmetrics
...
#[no_mangle]
pub unsafe extern fn oc_mode_metrics_print_rd(
  mut _fout: *mut FILE, mut _table_name: *const libc::c_char,
  mut _mode_rd_table: *mut [[[oc_mode_rd; 24]; 2]; 3]
) {
    ...
    while pli < 3i32 {
      ...
      while qti < 2i32 {
        ...
        while bin < 24i32 {
          ...
          fprintf(
            _fout,
            b"{%5i,%5i}\x00" as *const u8 as *const libc::c_char,
            (*_mode_rd_table.offset(qii as isize))[pli as usize][qti as usize]
              [bin as usize]
              .rate as libc::c_int,
            (*_mode_rd_table.offset(qii as isize))[pli as usize][qti as usize]
              [bin as usize]
...
#[no_mangle]
pub unsafe extern fn oc_mode_metrics_print(mut _fout: *mut FILE) {
  let mut qii: libc::c_int = 0;
  fprintf(_fout,
  ...
  fprintf(_fout, b"};\n\n\x00" as *const u8 as *const libc::c_char);
  oc_mode_metrics_print_rd(
    _fout,
    b"OC_MODE_RD_SATD\x00" as *const u8 as *const libc::c_char,
    OC_MODE_RD_SATD.as_mut_ptr()
  );
  oc_mode_metrics_print_rd(
    _fout,
    b"OC_MODE_RD_SAD\x00" as *const u8 as *const libc::c_char,
    OC_MODE_RD_SAD.as_mut_ptr()
  );
  fprintf(_fout, b"#endif\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern fn oc_enc_mode_metrics_load(mut _enc: *mut oc_enc_ctx) {
  if 0 == OC_HAS_MODE_METRICS {
    let mut fmetrics: *mut FILE = 0 as *mut FILE;
    memset(
      OC_MODE_METRICS_SATD.as_mut_ptr() as *mut libc::c_void,
      0i32,
      ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
        as libc::c_ulong
    );
    memset(
      OC_MODE_METRICS_SAD.as_mut_ptr() as *mut libc::c_void,
      0i32,
      ::std::mem::size_of::<[[[[oc_mode_metrics; 24]; 2]; 3]; 7]>()
        as libc::c_ulong
    );
    ...
    if !fmetrics.is_null() {
      fread(
        OC_MODE_LOGQ.as_mut_ptr() as *mut libc::c_void,
        ::std::mem::size_of::<[[[ogg_int16_t; 2]; 3]; 8]>() as libc::c_ulong,
        1i32 as libc::c_ulong,
        fmetrics
      );
        ...
        while pli < 3i32 {
          ...
          while qti < 2i32 {
            OC_MODE_LOGQ[qii as usize][pli as usize][qti as usize] =
              (*_enc).log_plq[qi as usize][pli as usize][qti as usize];
            qti += 1
          }
          pli += 1
        }
    ...
    oc_mode_metrics_update(
      OC_MODE_METRICS_SATD.as_mut_ptr(),
      100i32,
      1i32,
      OC_MODE_RD_SATD.as_mut_ptr(),
      9i32,
    ...
    oc_mode_metrics_update(
      OC_MODE_METRICS_SAD.as_mut_ptr(),
      100i32,
      1i32,
      OC_MODE_RD_SAD.as_mut_ptr(),
      6i32,
...
unsafe extern fn oc_token_skip_eob(
  mut _token: libc::c_int, mut _extra_bits: libc::c_int
) -> ptrdiff_t {
  let mut nblocks_adjust: libc::c_int = 0;
  nblocks_adjust = ((0i32 & 0xfi32
    | (1i32 & 0xfi32) << 4i32
    | (2i32 & 0xfi32) << 8i32
    | (3i32 & 0xfi32) << 12i32
    | (7i32 & 0xfi32) << 16i32
...
unsafe extern fn oc_token_skip_eob6(
  mut _token: libc::c_int, mut _extra_bits: libc::c_int
) -> ptrdiff_t {
  if 0 == _extra_bits {
...
unsafe extern fn oc_token_skip_run(
  ...
  ncoeffs_mask = ((3i32 & 0xffi32
    | (7i32 & 0xffi32) << 8i32
    | (0i32 & 0xffi32) << 16i32
    | (1i32 & 0xffi32) << 24i32)
    >> run_cati * 8i32) as libc::c_schar as libc::c_int;
  ncoeffs_adjust = ((7i32 & 0xffi32
    | (11i32 & 0xffi32) << 8i32
    | (2i32 & 0xffi32) << 16i32
    | (3i32 & 0xffi32) << 24i32)
    >> run_cati * 8i32) as libc::c_schar as libc::c_int;
...
static mut OC_TOKEN_SKIP_TABLE: [oc_token_skip_func; 32] = unsafe {
  [
    Some(
      oc_token_skip_eob
        as unsafe extern fn(_: libc::c_int, _: libc::c_int) -> ptrdiff_t
    ),
    Some(
      oc_token_skip_eob
        as unsafe extern fn(_: libc::c_int, _: libc::c_int) -> ptrdiff_t
    ...
    ::std::mem::transmute::<
      Option<unsafe extern fn() -> ptrdiff_t>,
      oc_token_skip_func
    >(Some(oc_token_skip_val as unsafe extern fn() -> ptrdiff_t)),
    ::std::mem::transmute::<
      Option<unsafe extern fn() -> ptrdiff_t>,
      oc_token_skip_func
    >(Some(oc_token_skip_val as unsafe extern fn() -> ptrdiff_t)),
    ...
    >(Some(oc_token_skip_val as unsafe extern fn() -> ptrdiff_t)),
    ::std::mem::transmute::<
      Option<unsafe extern fn(_: libc::c_int) -> ptrdiff_t>,
      oc_token_skip_func
    >(Some(
      oc_token_skip_run_cat1a as unsafe extern fn(_: libc::c_int) -> ptrdiff_t
    )),
    ::std::mem::transmute::<
      Option<unsafe extern fn(_: libc::c_int) -> ptrdiff_t>,
      oc_token_skip_func
...
unsafe extern fn oc_dct_token_skip(
  mut _token: libc::c_int, mut _extra_bits: libc::c_int
) -> ptrdiff_t {
  return OC_TOKEN_SKIP_TABLE[_token as usize]
    .expect("non-null function pointer")(_token, _extra_bits);
}
#[no_mangle]
pub unsafe extern fn oc_enc_mode_metrics_collect(mut _enc: *mut oc_enc_ctx) {
  ...
  while qii < (*_enc).state.nqis as libc::c_int {
    ...
    while pli < 3i32 {
      ...
      while qti < 2i32 {
        ...
        log_plq = (*_enc).log_plq[(*_enc).state.qis[qii as usize] as usize]
          [pli as usize][qti as usize] as libc::c_int;
        modeline = 0i32;
        while modeline < 8i32 - 1i32
          && OC_MODE_LOGQ[(modeline + 1i32) as usize][pli as usize]
            [qti as usize] as libc::c_int
            > log_plq
        {
          modeline += 1
        }
        modelines[qii as usize][pli as usize][qti as usize] = modeline;
        qti += 1
      }
      pli += 1
    }
  ...
  while pli < 3i32 {
    ...
    while zzi < 64i32 {
      ti[zzi as usize] =
        (*_enc).dct_token_offs[pli as usize][zzi as usize] as ptrdiff_t;
      if ti[zzi as usize] > 0i32 as libc::c_long {
        token = *(*(*_enc).dct_tokens[pli as usize].offset(zzi as isize))
          .offset(0isize) as libc::c_int;
        eb = *(*(*_enc).extra_bits[pli as usize].offset(zzi as isize))
          .offset(0isize) as libc::c_int;
        eob_token[zzi as usize] = token;
        eob_run[zzi as usize] = -oc_dct_token_skip(token, eb) as libc::c_int
      } else {
    ...
    while fragii < ncoded_fragis {
      ...
      while zzi < 64i32 {
        if eob_run[zzi as usize] > 0i32 {
          ...
          huffi = (*_enc).huff_idxs[qti as usize]
            [(zzi > 0i32) as libc::c_int as usize]
            [(pli + 1i32 >> 1i32) as usize] as libc::c_int
            + OC_ZZI_HUFF_OFFSET[zzi as usize] as libc::c_int;
          if eob_token[zzi as usize] < 7i32 {
            frag_bits += (*_enc).huff_codes[huffi as usize]
              [eob_token[zzi as usize] as usize]
              .nbits
              + OC_DCT_TOKEN_EXTRA_BITS[eob_token[zzi as usize] as usize]
                as libc::c_int;
            eob_token[zzi as usize] = 7i32
          }
          token = *(*(*_enc).dct_tokens[pli as usize].offset(zzi as isize))
            .offset(ti[zzi as usize] as isize)
            as libc::c_int;
          eb = *(*(*_enc).extra_bits[pli as usize].offset(zzi as isize))
            .offset(ti[zzi as usize] as isize) as libc::c_int;
          ti[zzi as usize] += 1;
          ...
          if skip < 0i32 {
            ...
            frag_bits += (*_enc).huff_codes[huffi as usize][token as usize]
              .nbits
              + OC_DCT_TOKEN_EXTRA_BITS[token as usize] as libc::c_int;
            zzi += skip
          }
        }
      }
      mb_mode = (*frags.offset(fragi as isize)).mb_mode() as libc::c_int;
      ...
      sqrt_ssd = sqrt(*frag_ssd.offset(fragi as isize) as libc::c_double);
      qtj = (mb_mode != 1i32) as libc::c_int;
      bin = (satd >> 9i32).wrapping_add(
        ((24i32 - 1i32) as libc::c_uint).wrapping_sub(satd >> 9i32)
          & -((((24i32 - 1i32) as libc::c_uint) < satd >> 9i32) as libc::c_int)
            as libc::c_uint
      ) as libc::c_int;
      oc_mode_metrics_add(
        OC_MODE_METRICS_SATD
          [modelines[qii as usize][pli as usize][qtj as usize] as usize]
          [pli as usize][qtj as usize]
          .as_mut_ptr()
          .offset(bin as isize),
        fragw,
        satd as libc::c_int,
        (*_enc).log_plq[qi as usize][pli as usize][qtj as usize]
          as libc::c_int,
        frag_bits,
        sqrt_ssd
      );
      bin = (sad >> 6i32).wrapping_add(
        ((24i32 - 1i32) as libc::c_uint).wrapping_sub(sad >> 6i32)
          & -((((24i32 - 1i32) as libc::c_uint) < sad >> 6i32) as libc::c_int)
            as libc::c_uint
      ) as libc::c_int;
      oc_mode_metrics_add(
        OC_MODE_METRICS_SAD
